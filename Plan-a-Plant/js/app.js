 ...
 */            (function(window, factory) {
    ...
    (() => {
        ...
        function navDecor() {
            ...
            var item = document.querySelectorAll("button.tabs__title");
            if (marker) {
...
***************************************************************************** */
        ...
        if (galleries.length) {
            ...
            galleyItems[0].galleryClass.openGallery();
        }
        ...
        if (items) {
            ...
            var checkboxes = document.querySelectorAll(".filter__include-checkbox-wrapper input, .filter__categories-wrapper input");
