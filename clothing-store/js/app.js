(() => {
    ...
    function activeColor() {
        document.addEventListener("click", (function(e) {
            if (e.target.closest(".card-product__color-wrapper")) {
                let colors = e.target.parentElement.parentElement.children;
                for (let index = 0; index < colors.length; index++) {
                    const currentColor = colors[index];
                    currentColor.classList.remove("_active");
                }
    ...
    modules_flsModules.tippyZoom = tippy_esm(".card-product__zoom", {
        animation: "shift-toward",
        placement: "left",
        content: "Zoom in"
    });
    ...
    function initSliders() {
        ...
        if (document.querySelector(".season-collection__slider")) new core(".season-collection__slider", {
            ...
            speed: 800,
            pagination: {
                el: ".season-collection-pagination",
                clickable: true
            },
            navigation: {
                prevEl: ".season-collection-button-prev",
                nextEl: ".season-collection-button-next"
            },
            on: {}
        });
        if (document.querySelector(".products-best__slider")) new core(".products-best__slider", {
            ...
            speed: 800,
            pagination: {
                el: ".products-best-pagination",
                clickable: true
            },
            navigation: {
                prevEl: ".products-best-button-prev",
                nextEl: ".products-best-button-next"
            },
            breakpoints: {
                1319: {
                    enabled: false,
