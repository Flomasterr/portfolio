(() => {
    ...
    (() => {
        ...
        const picker = datepicker_min("[data-datepicker]", {
            customDays: [ "Mon", "Tue", "Wen", "Thu", "Fri", "Sat", "Sun" ],
            customMonths: [ "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Okt", "Nov", "Dec" ],
            overlayButton: "Apply",
        ...
        const pickerSecond = datepicker_min("[data-datepicker-second]", {
            customDays: [ "Mon", "Tue", "Wen", "Thu", "Fri", "Sat", "Sun" ],
            customMonths: [ "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Okt", "Nov", "Dec" ],
            overlayButton: "Apply",
            overlayPlaceholder: "Year (4 digits)",
        ...
        modules_flsModules.datepicker = pickerSecond;
        ...
        function wrapInSpan() {
            ...
            if (wrapElems) wrapElems.forEach((elem => {
                ...
                elem.innerHTML = "";
                for (let index = 0; index < textArray.length; index++) elem.innerHTML += `<span>${textArray[index]}</span>`;
            }));
        }
        wrapInSpan();
        window["FLS"] = false;
